...
<div class="list-group">
    ...
    <?= $this->Html->link('My Coin Requests', ['prefix' => 'profile', 'controller' => 'CoinRequests'], ['class' => $controller === "CoinRequests" ? 'list-group-item list-group-item-action active' : 'list-group-item list-group-item-action']) ?>
